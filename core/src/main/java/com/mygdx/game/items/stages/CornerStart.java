...
public class CornerStart extends Stage {
	public CornerStart(){
		...
		enemySpawnY 	= new int[]{};
		enemyType		= new int[]{};
		screenWarpX 	= new int[]{0, 23};
		screenWarpY		= new int[]{0, 5};
		screenWarpIsHorizontal	= new boolean[]{true, false};
		screenWarpAlignment		= new boolean[]{false, false};
		screenWarpSize			= new float[]{2.0f, 3.0f};
