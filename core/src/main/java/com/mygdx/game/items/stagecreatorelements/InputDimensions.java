...
public class InputDimensions extends GUI {
	...
	public void render(){
		if(!spareFrame) {
			mathCalculator();
			fixatedDrawables.add(TextureManager.getDrawable(texture, startingX, startingY,0, 1,0, false, false, size, size, true));
	...
	public void mathCalculator(){
		...
		for (String k : keys) {
			if (k.equals("0") || k.equals("1") || k.equals("2") || k.equals("3") || k.equals("4") || k.equals("5") || k.equals("6") || k.equals("7") ||
					k.equals("8") || k.equals("9") || (k.equals("x") && storedText != null && storedText.indexOf('x') == -1))
